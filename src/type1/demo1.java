...
//        kwic.input("E:\\input.txt");
        ...
        kwic.shift();
        kwic.alphabetizer();
        kwic.output(outFileName);
        return new File(outFileName);
    }


    public void input(String fileName) {
        System.out.println("调用子程序：input");
        try {
    ...
    public void output(String filename){
        System.out.println("调用子程序：output");
    ...
    public void shift() {
        System.out.println("调用子程序：shift");
    ...
    public void alphabetizer() {
        System.out.println("调用子程序：alphabetizer");
